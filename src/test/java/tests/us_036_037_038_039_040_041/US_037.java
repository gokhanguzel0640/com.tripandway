...
public class US_037 extends TestBaseRapor {
    @Test
    public void TC_01(){
         extentTest= extentReports.createTest("Accessing the admin account profile settings screen",
         "An admin can access the admin account profile settings screen to make changes on the profile information");
    ...
    Assert.assertTrue(admin_dashboard_us36_us37_us38_us39_us40_us41_page.profileChangePasswordButton.isDisplayed());
         extentTest.pass("06_Admin user tests that admin account profile settings screen is displayed");
    }
}
