...
public class US_039 extends TestBaseRapor {
    @Test
    public void TC_01() {
         extentTest = extentReports.createTest("Accessing the admin account photo change screen",
         "An admin can access the admin account photo change screen to update the profile picture");
    ...
    Admin_dashboard_Us36_Us37_Us38_Us39_Us40_Us41_Page admin_dashboard_us36_us37_us38_us39_us40_us41_page = new
        ...
        admin_dashboard_us36_us37_us38_us39_us40_us41_page.profileChangePhotoButton.click();
        extentTest.info("06_Admin user clicks on the Change Photo button");
    Assert.assertTrue(admin_dashboard_us36_us37_us38_us39_us40_us41_page.existingFotoIcon.isDisplayed());
        extentTest.pass("07_Admin user tests that the admin account photo change screen is displayed");
    }
}
