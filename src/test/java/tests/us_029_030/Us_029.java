...
public class Us_029 extends TestBaseRapor{
    ...
    public void test01() {
        ...
        extentTest.info("Sırasıyla 'Blog Name', 'Blog Slug', 'Blog Content', 'Blog Short Content' bölümelerini doldurur");
        ...
        extentTest.info("'Select Category' bölümünden seyehat türünü seçer");
        ...
        extentTest.info("'Show Comment?' bölümünden ilgili seçimi yapar");
        ...
        extentTest.info("Sırasıyla 'Title' ve 'Meta Description' bölümlerini doldurur ve 'Submit' butonuna tıklar");
        ...
        public void test02(){
        extentTest = extentReports.createTest("Admin Blog Section Testi" +
                                "\nKullanici Admin girişi yaptıktan sonra Blog Section bölümüne eklenen yaziyi duzenleyebilmeli");
        ...
        extentTest.info("Açılan sayfada ilgili blog yazısıdaki 'edit' butonuna tıklar");
        ...
        extentTest.pass("Ilgili birimleri düzenler ve 'Update' butonuna tıklayarak " +
                                "yazının düzenlenebilir olduğunu test eder");
    ...
    public void test03(){
        extentTest = extentReports.createTest("Admin Blog Section Testi" +
                "\nKullanici Admin girişi yaptıktan sonra Blog Section bölümüne eklenen yaziyi silebilmeli");
        ...
        extentTest.info("Açılan sayfada ilgili blog yazısındaki 'delete' butonuna tıklar");
        ...
        extentTest.pass("Çıkan alerts'de 'Tamam' butonuna tıklayarak blog yazısının silindiğini test eder");
